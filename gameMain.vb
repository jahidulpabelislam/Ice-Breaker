...
#Region "Variables"
    ...
    Private gamePaddle As Rectangle = New Rectangle(300, 430, 72, 10)

    Private gameBall As Rectangle = New Rectangle(gamePaddle.X + 60 / 2 _
    - (16 / 2), 300 - 16, 16, 16)
        ...
        For rows As Integer = 0 To brickRows
            For columns As Integer = 0 To brickColumns
                ...
                If gameBall.IntersectsWith(brickArray(rows, columns)) Then
                    ...
                    score(arraycount) += 50
                    TextBox1.Text = score(arraycount)
